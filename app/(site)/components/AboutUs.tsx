...
const AboutUs = () => {
    ...
    const imageValue = useTransform(scrollYProgress, [0, 1], [-30, 30])
        ...
        <>
            ...
            w-full 
              `}
                ...
                <div className={`lg:max-w-[450px] flex-grow relative mb-[1000px]`}>
                    <motion.div
                    ...
                    <Image src={aboutUs2Left} alt={``} width={70} height={70} className={`absolute bottom-8 left-9`}/>
                    <Image src={aboutUs1Right} alt={``} width={95} height={95} className={`absolute right-2 top-[15%]`}/>
                </div>
            </section>
            <section>
