...
const PhoneNumber:FC<PhoneNumberProps> = ({className}) => {
    return(
        <div className={cn(`lg:border-l border-neutral-800 pl-3 ml-3 flex-grow hidden lg:block`, className)}>
            <a className={`font-semibold flex truncate`} href={`tel: +79995553322`}>
